...
/*   Updated: 2019/04/29 11:23:51 by mjalenqu    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
char				*flag_zero(t_data data, char *arg)
{
	...
	if (data.flag[i] == '\0' && (size_t)ft_strlen(arg) < (size_t)data.width)
	{
		while ((size_t)ft_strlen(arg) < ((size_t)data.width - tmp_plus -
